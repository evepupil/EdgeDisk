...
<body>
  ...
  <script>
    ...
    const ensureFolderPath=(value)=>{const input=String(value||'').trim().replace(/\\+/g,'/').replace(/^\/+|\/+$/g,'');return input?input+'/':''};
