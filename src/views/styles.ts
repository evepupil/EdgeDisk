export const styles = `
  ...
  *{box-sizing:border-box}body{margin:0;background:linear-gradient(180deg,#08111f,#0b1220);color:var(--text)}a{text-decoration:none;color:inherit}button,input,select{font:inherit}
  ...
  .btn.active{border-color:#60a5fa99;background:#172554}
  ...
  .cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px}.card-item{padding:14px;border:1px solid var(--line);border-radius:16px;background:#0f172a88;display:grid;gap:10px;min-height:160px}.card-item-top{display:flex;justify-content:space-between;align-items:flex-start;gap:8px}.card-icon{font-size:42px;line-height:1}.card-name{word-break:break-word;font-size:14px}.card-meta{display:grid;gap:4px;color:var(--muted);font-size:12px}.hidden{display:none !important}
